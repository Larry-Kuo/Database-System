...
public:
	...
	void generateCombinations(vector<pair<string, string>>& items, vector<pair<string, string>>& group1, vector<pair<string, string>>& group2, int index, vector<Result>& results);
