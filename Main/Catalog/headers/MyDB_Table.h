...
public:
  // creates a new table with the given name, at the given storage location; the
  // schema is empty
  MyDB_Table(string tableName, string storageLoc);

  // creates a table with the given name, at the given storage location, and the
  // given schema
  MyDB_Table(string tableName, string storageLoc, MyDB_SchemaPtr mySchema);

  // creates a table with the given name, at the given storage location, and the
  // given schema, of the given type, with the given sort att
  MyDB_Table(string tableName, string storageLoc, MyDB_SchemaPtr mySchema,
