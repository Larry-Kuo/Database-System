...
public:
  ...
  virtual ~MyDB_AttType() {}
};

class MyDB_IntAttType : public MyDB_AttType {

public:
  bool promotableToInt() { return true; }

  bool promotableToDouble() { return true; }

  string toString() { return "int"; }

  bool promotableToString() { return true; }

  bool isBool() { return false; }

  MyDB_AttValPtr createAtt() { return make_shared<MyDB_IntAttVal>(); }
...
public:
  bool promotableToInt() { return false; }
  ...
  MyDB_AttValPtr createAtt() { return make_shared<MyDB_DoubleAttVal>(); }
...
public:
  ...
  bool promotableToDouble() { return false; }
  ...
  MyDB_AttValPtr createAtt() { return make_shared<MyDB_StringAttVal>(); }
...
public:
  ...
  MyDB_AttValPtr createAtt() { return make_shared<MyDB_BoolAttVal>(); }
